...
type (
	...
	CalculateMigrationGasFunc func(db StateDB, migrationMsg *stakingTypes.MigrationMsg, homestead bool, istanbul bool, isEIP3860 bool) (uint64, error)
)
...
func (evm *EVM) GetConfig() Config { return evm.Config }
